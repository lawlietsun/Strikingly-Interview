...
setwd("~/Desktop/strikingly Interview")

dict <- read.table(file = "wordsEn.txt")
dict <- unique(dict)
write.table(dict, file = "wordsEne.txt", row.names = FALSE, col.names = FALSE)
dict <- read.table("wordsEne.txt")
words <- c() # take notes for all the works appears for future use
